...
if(isset($_POST['username'])){
    ...
    $sql = "SELECT * FROM admini WHERE korisnickoIme = '".$user."' AND lozinka='".$pass."' LIMIT 1";
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('slikePrijaveKorisnika/slika3.jpg');">
